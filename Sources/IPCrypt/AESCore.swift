...
struct AESCore {
    ...
    // Precomputed GF(2^8) multiplication tables for common multipliers
    static let gfMul2Table: [UInt8] = [
    ...
    // Fast table lookup versions of GF multiplication
    ...
    static func gfMul8(_ x: UInt8) -> UInt8 {
        gfMul8Table[Int(x)]
    }
    ...
    static func gfMul13(_ x: UInt8) -> UInt8 {
        // 13 = 8 + 4 + 1
        let x4 = gfMul2(gfMul2(x))
        return gfMul8(x) ^ x4 ^ x
    }
